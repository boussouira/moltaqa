...
void UtilsTest::shamelaShoorts_data()
{
    QTest::addColumn<QString>("origin");
    QTest::addColumn<QString>("expected");
    QTest::addColumn<bool>("hasShoort");

    QTest::newRow("Simple A")
            << _u("كقوله A يوم خيبر: إن الله ورسوله ينهيانكم عن الحمر الإنسية فإنها رجس")
            << _u("كقوله صلى الله عليه وسلم يوم خيبر: إن الله ورسوله ينهيانكم عن الحمر الإنسية فإنها رجس")
            << true;

    QTest::newRow("Long A")
            << _u(" ثم جاءت السنة فحرمت أشياء لم تذكر في هذه الآية كقوله A : \" كل ذي ناب من السباع وكل ذي مخلب من الطير حرام \". وفي الباب أحاديث أخرى في النهي عن ذلك. كقوله A يوم خيبر: \" إن الله ورسوله ينهيانكم عن الحمر الإنسية فإنها رجس \" [أخرجه الشيخان]")
            << _u(" ثم جاءت السنة فحرمت أشياء لم تذكر في هذه الآية كقوله صلى الله عليه وسلم : \" كل ذي ناب من السباع وكل ذي مخلب من الطير حرام \". وفي الباب أحاديث أخرى في النهي عن ذلك. كقوله صلى الله عليه وسلم يوم خيبر: \" إن الله ورسوله ينهيانكم عن الحمر الإنسية فإنها رجس \" [أخرجه الشيخان]")
            << true;

    QTest::newRow("Line start A")
            << _u("A : \" لا قطع إلا في ربع دينار فصاعدا \" [أخرجه الشيخان]. كما بينت الآخر بفعله A أو فعل أصحابه وإقراره فإنهم كانوا يقطعون يد السارق من عند المفصل كما هو معروف في كتب لحديث وبينت السنة القولية اليد المذكورة في آية التيمم: {فامسحوا بوجوهكم وأيديكم} [النساء: 43، المائدة: 6] بأنها الكف أيضا بقوله A : \" التيمم ضربة للوجه والكفين \" [أخرجه أحمد والشيخان وغيرهم من حديث عمار بن ياسر رضي الله عنهما]")
            << _u("صلى الله عليه وسلم : \" لا قطع إلا في ربع دينار فصاعدا \" [أخرجه الشيخان]. كما بينت الآخر بفعله صلى الله عليه وسلم أو فعل أصحابه وإقراره فإنهم كانوا يقطعون يد السارق من عند المفصل كما هو معروف في كتب لحديث وبينت السنة القولية اليد المذكورة في آية التيمم: {فامسحوا بوجوهكم وأيديكم} [النساء: 43، المائدة: 6] بأنها الكف أيضا بقوله صلى الله عليه وسلم : \" التيمم ضربة للوجه والكفين \" [أخرجه أحمد والشيخان وغيرهم من حديث عمار بن ياسر رضي الله عنهما]")
            << true;
}

void UtilsTest::shamelaShoorts()
{
    QFETCH(QString, origin);
    QFETCH(QString, expected);
    QFETCH(bool, hasShoort);

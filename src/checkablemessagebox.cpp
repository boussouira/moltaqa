...
public:
        ...
        : clickedButton(0)
    {
        ...
        checkBox->setText(CheckableMessageBox::tr("لا تعرض هذه الرسالة مجددا"));
                              ...
                              QDialogButtonBox::StandardButton defaultButton)
{
    ...
    if(checkBoxText.size())
        mb.setCheckBoxText(checkBoxText);

    if(Utils::Settings::get(settingsKey, true).toBool())
        mb.exec();
    else
        return returnButtonIfNotShown;

    if(mb.isChecked())
        Utils::Settings::set(settingsKey, false);
...
QDialogButtonBox::StandardButton
CheckableMessageBox::warning(QWidget *parent,
                             const QString &title,
                             const QString &messageText,
                             const QString &settingsKey,
                             QDialogButtonBox::StandardButton returnButtonIfNotShown,
